...
public class Modelgorilla<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(13, 50)
						.addBox(-3.0F, -7.0F, -5.0F, 6.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(34, 7)
						...
						.addBox(-8.0F, -7.5F, -3.0F, 4.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(34, 50)
						.addBox(4.0F, -7.5F, -3.0F, 4.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightcheek_r1 = body.addOrReplaceChild("rightcheek_r1",
				CubeListBuilder.create().texOffs(46, 44).addBox(0.1F, -2.0F, -2.0F, 6.0F, 6.0F, 3.0F,
		...
		PartDefinition leftcheek_r1 = body.addOrReplaceChild("leftcheek_r1",
				CubeListBuilder.create().texOffs(46, 44).addBox(-6.1F, -2.0F, -2.0F, 6.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition outer_r1 = body.addOrReplaceChild("outer_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -16.0F, 11.0F, 8.0F, 24.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition dick = partdefinition.addOrReplaceChild("dick", CubeListBuilder.create().texOffs(0, 60).addBox(
				-2.0F, -8.0F, 3.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = dick.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 48).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 9.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -10.0F, 4.0F, -1.4399F, 0.0F, 0.0F));

		PartDefinition leftleg = partdefinition.addOrReplaceChild("leftleg",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -1.0F, -3.0F, 7.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-4.0F, 10.0F, -6.0F, 5.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-2.0F, 11.0F, -8.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-4.0F, 10.0F, -8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 12.0F, 7.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition cube_r2 = leftleg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.0F, -2.0F, 5.0F, 5.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 6.0F, -2.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r3 = leftleg.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -2.0F, -3.0F, 6.0F, 6.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 5.0F, 1.0F, -0.5672F, 0.0F, 0.0F));

		PartDefinition rightleg = partdefinition.addOrReplaceChild("rightleg",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, -2.0F, -3.0F, 7.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, 9.0F, -6.0F, 5.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(2.0F, 9.0F, -8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, 10.0F, -8.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 13.0F, 7.0F, 0.0F, 0.1309F, 0.0F));

		PartDefinition cube_r4 = rightleg
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(0, 0).addBox(-10.0F, 0.0F, -2.0F, 5.0F, 5.0F, 5.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(9.0F, 5.0F, -2.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r5 = rightleg
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -2.0F, -3.0F, 6.0F, 6.0F, 5.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition unterarm_r1 = leftarm.addOrReplaceChild("unterarm_r1",
				CubeListBuilder.create().texOffs(20, 37).addBox(-0.3F, 9.25F, 4.0F, 5.0F, 9.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition oberarm_r1 = leftarm.addOrReplaceChild("oberarm_r1",
				CubeListBuilder.create().texOffs(28, 0).addBox(-0.3F, 4.0F, -5.0F, 5.0F, 9.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition schulter_r1 = leftarm.addOrReplaceChild("schulter_r1",
				CubeListBuilder.create().texOffs(0, 14).addBox(-2.0F, -1.5F, -5.0F, 7.0F, 7.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition hand = leftarm.addOrReplaceChild("hand",
				CubeListBuilder.create().texOffs(37, 31)
						.addBox(-1.3F, 18.0F, -6.5F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(38, 39)
		...
		PartDefinition rightarm = partdefinition.addOrReplaceChild("rightarm", CubeListBuilder.create(),
				PartPose.offset(-5.0F, 6.0F, -8.0F));

		PartDefinition unterarm_r2 = rightarm.addOrReplaceChild("unterarm_r2",
				CubeListBuilder.create().texOffs(23, 23).addBox(-5.4F, 9.25F, 4.0F, 5.0F, 9.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition oberarm_r2 = rightarm.addOrReplaceChild("oberarm_r2",
				CubeListBuilder.create().texOffs(0, 28).addBox(-5.3F, 4.0F, -5.0F, 5.0F, 9.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition schulter_r2 = rightarm.addOrReplaceChild("schulter_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -1.5F, -5.0F, 7.0F, 7.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition hand2 = rightarm.addOrReplaceChild("hand2",
				CubeListBuilder.create().texOffs(28, 14)
						.addBox(-14.3F, 18.0F, -6.5F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(38, 22)
