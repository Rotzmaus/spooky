...
public class Modelnewversionostrich<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "newversionostrich"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body2 = partdefinition.addOrReplaceChild("body2",
				CubeListBuilder.create().texOffs(66, 0)
						.addBox(-7.5F, -22.0F, -8.0F, 15.0F, 9.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(78, 47)
						.addBox(-6.5F, -24.0F, -6.0F, 13.0F, 13.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition leftfoot2 = partdefinition.addOrReplaceChild("leftfoot2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 12.0F, 0.0F));

		PartDefinition leftfoot_r1 = leftfoot2.addOrReplaceChild("leftfoot_r1",
				CubeListBuilder.create().texOffs(0, 111)
						.addBox(1.01F, -15.0F, -5.01F, 1.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(112, 125)
		...
		PartDefinition cube_r1 = leftfoot2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(112, 125).addBox(-3.0F, -0.99F, -4.0F, 6.0F, 1.0F, 2.0F,
		...
		PartDefinition cube_r2 = leftfoot2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(112, 125).addBox(-7.0F, -1.01F, -5.0F, 6.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.0F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition rightfoot2 = partdefinition.addOrReplaceChild("rightfoot2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 12.0F, 0.0F));

		PartDefinition rightfoot_r1 = rightfoot2.addOrReplaceChild("rightfoot_r1",
				CubeListBuilder.create().texOffs(0, 111)
						.addBox(1.01F, -15.0F, 3.01F, 1.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(112, 125)
		...
		PartDefinition cube_r3 = rightfoot2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(112, 125).addBox(-3.0F, -1.001F, 2.0F, 6.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.0F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition cube_r4 = rightfoot2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(112, 125).addBox(-7.0F, -1.0F, 3.0F, 6.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.0F, 0.0F, 0.0F, -1.0472F, 0.0F));
		...
		PartDefinition lowerbear_r1 = head2
				.addOrReplaceChild("lowerbear_r1",
						CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -0.5F, -5.5F, 4.0F, 1.0F, 5.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition righteye_r1 = head2.addOrReplaceChild("righteye_r1",
				CubeListBuilder.create().texOffs(24, 36)
						.addBox(-7.0F, 23.0F, -8.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 30)
		...
		PartDefinition head_r1 = head2.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(51, 61).addBox(-6.0F, -3.0F, 2.0F, 6.0F, 7.0F, 6.0F,
						new CubeDeformation(0.0F)),
