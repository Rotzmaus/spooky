...
public class Modelbigheadedfish<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bigheadedfish"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Front = partdefinition.addOrReplaceChild("Front",
				CubeListBuilder.create().texOffs(26, 10)
						.addBox(-1.0F, -1.25F, -2.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 9)
		...
		PartDefinition Mid = partdefinition.addOrReplaceChild("Mid",
				CubeListBuilder.create().texOffs(0, 15)
						.addBox(-1.25F, -2.0F, -3.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 25)
						.addBox(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 22.0F, 3.0F));

		PartDefinition back = partdefinition.addOrReplaceChild("back",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -1.5F, 0.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(26, 0)
