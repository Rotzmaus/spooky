...
public class Modelpingu<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "pingu"), "main");
	private final ModelPart body;
	private final ModelPart head;
	private final ModelPart leftwing;
	private final ModelPart rightwing;
	private final ModelPart stubbylegs;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = body
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -12.0F, -3.0F, 8.0F, 10.0F, 6.0F,
		...
		PartDefinition beak_r1 = head.addOrReplaceChild("beak_r1",
				CubeListBuilder.create().texOffs(28, 7)
						.addBox(-1.0F, -11.0F, 3.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(1.0F, -15.0F, 4.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
						.addBox(-2.0F, -14.0F, 4.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(24, 12).addBox(-2.0F, -14.0F, 0.0F, 5.0F, 5.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leftwing_r1 = leftwing.addOrReplaceChild("leftwing_r1",
				CubeListBuilder.create().texOffs(0, 16).addBox(-6.0F, -11.0F, -2.0F, 2.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rightwing_r1 = rightwing
				.addOrReplaceChild("rightwing_r1",
						CubeListBuilder.create().texOffs(12, 16).addBox(4.0F, -11.0F, -2.0F, 2.0F, 11.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(5.0F, 10.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition stubbylegs = partdefinition.addOrReplaceChild("stubbylegs", CubeListBuilder.create(),
				PartPose.offset(0.0F, 21.0F, 0.0F));

		PartDefinition leftleg_r1 = stubbylegs
				.addOrReplaceChild("leftleg_r1",
						CubeListBuilder.create().texOffs(24, 21).addBox(-3.0F, -4.0F, -2.0F, 3.0F, 4.0F, 3.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition rightleg_r1 = rightlegs
				.addOrReplaceChild("rightleg_r1",
						CubeListBuilder.create().texOffs(28, 0).addBox(0.0F, -4.0F, -2.0F, 3.0F, 4.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
