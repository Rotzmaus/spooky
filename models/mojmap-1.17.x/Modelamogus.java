...
public class Modelamogus<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart bbb;
	private final ModelPart aaa;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bbb = partdefinition.addOrReplaceChild("bbb", CubeListBuilder.create().texOffs(0, 17).addBox(
				-2.0F, 0.0F, -2.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 19.0F, 0.5F));

		PartDefinition aaa = partdefinition.addOrReplaceChild("aaa", CubeListBuilder.create().texOffs(18, 17).addBox(
				-2.0F, 0.0F, -2.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 19.0F, 0.5F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-6.0F, -17.0F, -2.0F, 12.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(16, 27)
