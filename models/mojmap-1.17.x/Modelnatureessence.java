...
public class Modelnatureessence<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "natureessence"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(44, 48)
						.addBox(-5.0F, -8.0F, -4.0F, 9.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(66, 14)
						.addBox(-3.0F, -21.0F, -2.0F, 5.0F, 21.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(49, 0)
		...
		PartDefinition layer = partdefinition.addOrReplaceChild("layer",
				CubeListBuilder.create().texOffs(0, 48)
						.addBox(-6.0F, -14.0F, -5.0F, 11.0F, 14.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-8.0F, -31.0F, -8.0F, 16.0F, 31.0F, 17.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
