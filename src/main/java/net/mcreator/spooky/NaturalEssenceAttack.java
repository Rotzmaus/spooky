...
public class NaturalEssenceAttack extends MeleeAttackGoal {
 ...
 protected final PathfinderMob mob;
   ...
   public NaturalEssenceAttack(NatureEssenceEntity p_26019_, double p_26020_, boolean p_26021_) {
      super(p_26019_, p_26020_, p_26021_);
      this.mob = p_26019_;
      this.speedModifier = p_26020_;
      this.followingTargetEvenIfNotSeen = p_26021_;
   }
   ...
   protected void checkAndPerformAttack(LivingEntity p_25557_, double p_25558_) {
      ...
      if (p_25558_ <= (d0 +180.0d) && this.ticksUntilNextAttack <= 0) {
