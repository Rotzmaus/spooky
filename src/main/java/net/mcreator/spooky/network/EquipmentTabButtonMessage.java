...
public class EquipmentTabButtonMessage {
	...
	public EquipmentTabButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(EquipmentTabButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(EquipmentTabButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 1) {
			...
			BuySwordProcedure.execute(entity);
		}
		if (buttonID == 2) {

			BuyChestplateProcedure.execute(entity);
		}
		if (buttonID == 3) {

			BuyLegginsProcedure.execute(entity);
		}
		if (buttonID == 4) {
