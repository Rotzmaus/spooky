...
import net.mcreator.spooky.client.particle.SandDigParticle;
...
public class SpookyModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType SAND_DIG = register(new SimpleParticleType(false).setRegistryName("sand_dig"), SandDigParticle::provider);
