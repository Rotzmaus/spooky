...
public class OstrichAttackGoal extends LeapAtTargetGoal {
   private final Mob mob;
   private LivingEntity target;
   private final float yd;

   public OstrichAttackGoal(Mob p_25492_, float p_25493_) {
   ...
   public void start() {
      ...
      this.mob.setDeltaMovement(((vec31.x) * -3), (double)this.yd , ((vec31.z) * -3));
		// damage
