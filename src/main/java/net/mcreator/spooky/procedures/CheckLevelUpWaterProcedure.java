...
public class CheckLevelUpWaterProcedure {
	public static void execute(LevelAccessor world, Entity sourceentity) {
		if (sourceentity == null)
			return;
		if ((sourceentity.getCapability(SpookyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new SpookyModVariables.PlayerVariables())).WaterExp >= (sourceentity
			...
			WaterREspondToLevelupProcedure.execute(sourceentity);
			new Object() {
				private int ticks = 0;
