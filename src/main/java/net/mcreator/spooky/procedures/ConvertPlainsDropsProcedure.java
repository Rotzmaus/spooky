...
public class ConvertPlainsDropsProcedure {
		...
		if (ItemMultiplier != 0) {
			{
				double _setval = (entity.getCapability(SpookyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
						.orElse(new SpookyModVariables.PlayerVariables())).PlainsEXP + new Object() {
			...
			CLUPNotSourceEntitiyProcedure.execute(world, entity);
