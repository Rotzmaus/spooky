...
public class ConvertCPDropsProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get()instanceof Map _slt
				...
				: ItemStack.EMPTY).getItem() == SpookyModItems.PINGU_EGG) {
			ItemMultiplier = 5;
		...
		if (ItemMultiplier != 0) {
			{
				double _setval = (entity.getCapability(SpookyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
						.orElse(new SpookyModVariables.PlayerVariables())).ColdPLacesEXP + new Object() {
			...
			CLUColdPlacesNotSourceEntityProcedure.execute(world, entity);
