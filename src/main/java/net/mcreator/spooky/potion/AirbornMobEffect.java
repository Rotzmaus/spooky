...
import net.mcreator.spooky.procedures.MakeTheGroundShakeProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class AirbornMobEffect extends MobEffect {
	public AirbornMobEffect() {
		super(MobEffectCategory.BENEFICIAL, -10040065);
		setRegistryName("airborn");
	}

	@Override
	public String getDescriptionId() {
		return "effect.spooky.airborn";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		...
		MakeTheGroundShakeProcedure.execute(world, x, y, z, entity);
	}
