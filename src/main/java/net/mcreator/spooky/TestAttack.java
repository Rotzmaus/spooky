...
public class TestAttack extends MeleeAttackGoal {
 ...
 protected final PathfinderMob mob;
   ...
   public TestAttack(SpankyEntity p_26019_, double p_26020_, boolean p_26021_) {
   ...
   protected void checkAndPerformAttack(LivingEntity p_25557_, double p_25558_) {
      ...
      if (p_25558_ <= (d0 +80.0d) && this.ticksUntilNextAttack <= 0) {
