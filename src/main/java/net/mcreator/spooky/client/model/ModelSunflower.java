...
public class ModelSunflower<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("spooky", "model_sunflower"), "main");
	public final ModelPart Head;
	public final ModelPart stengel;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 8).addBox(-5.0F, -33.0F, -4.0F, 10.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(32, 36)
		...
		PartDefinition stengel = partdefinition.addOrReplaceChild(
				"stengel", CubeListBuilder.create().texOffs(26, 2).addBox(-3.0F, -2.0F, -2.8F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(42, 46).addBox(-1.5F, -27.0F, 2.0F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition RightLeave2_r1 = stengel.addOrReplaceChild("RightLeave2_r1",
				CubeListBuilder.create().texOffs(0, 21).addBox(0.5F, -5.0F, -2.7F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLeave2_r1 = stengel.addOrReplaceChild("LeftLeave2_r1",
				CubeListBuilder.create().texOffs(15, 22).addBox(-1.5F, -4.0F, -0.7F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeave_r1 = stengel.addOrReplaceChild("RightLeave_r1",
				CubeListBuilder.create().texOffs(17, 52).addBox(-2.0F, -9.0F, -4.5F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLeave_r1 = stengel.addOrReplaceChild("LeftLeave_r1",
				CubeListBuilder.create().texOffs(0, 53).addBox(0.0F, -8.0F, -4.5F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -27.0F, 2.0F, 1.3526F, -1.789F, 0.0F));
		PartDefinition cube_r1 = stengel.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(34, 45).addBox(-1.0F, -3.0F, -1.5F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -27.0F, 2.0F, 1.3526F, 0.0F, 0.0F));
		PartDefinition cube_r2 = stengel.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(16, 36).addBox(-2.0F, -11.0F, 0.4F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -9.0F, 0.0F, -0.0873F, 0.0F, 0.0F));
		PartDefinition Basestump_r1 = stengel.addOrReplaceChild("Basestump_r1",
				CubeListBuilder.create().texOffs(24, 22).addBox(-2.5F, -10.0F, -2.5F, 5.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
		PartDefinition Leave = partdefinition.addOrReplaceChild("Leave",
				CubeListBuilder.create().texOffs(0, 21).addBox(-1.0F, 0.0F, 1.0F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(24, 45)
						...
						.addBox(0.0F, 0.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(23, 9).addBox(0.0F, 0.0F, 10.0F, 1.0F, 1.0F,
		...
		PartDefinition Leave2 = partdefinition.addOrReplaceChild("Leave2",
				CubeListBuilder.create().texOffs(17, 12).addBox(-2.0F, -1.0F, 2.0F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(44, 12)
						...
						.addBox(-1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(21, 22).addBox(-1.0F, -1.0F, 11.0F, 1.0F,
