...
import net.mcreator.spooky.procedures.MummyEntityIsHurtProcedure;
import net.mcreator.spooky.procedures.MummyDiesProcedure;
...
public class MummyEntity extends Monster {
	...
	public MummyEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(SpookyModEntities.MUMMY, world);
	}
	...
	public MummyEntity(EntityType<MummyEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Mummy"));
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, MummyEntity.class, false, false));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		...
		MummyEntityIsHurtProcedure.execute(world, x, y, z, entity);
	...
	public void die(DamageSource source) {
		...
		MummyDiesProcedure.execute(world, sourceentity);
	}
