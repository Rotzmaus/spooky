...
import net.mcreator.spooky.procedures.NatureEssenceEntityIsHurtProcedure;
import net.mcreator.spooky.procedures.NatureEssenceDiesProcedure;
...
public class NatureEssenceEntity extends Monster implements RangedAttackMob {
	...
	public NatureEssenceEntity(EntityType<NatureEssenceEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
		setCustomName(new TextComponent("Nature Essence"));
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 0.7, 20) {
			...
			protected Vec3 getPosition() {
				Random random = NatureEssenceEntity.this.getRandom();
				double dir_x = NatureEssenceEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = NatureEssenceEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = NatureEssenceEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public boolean hurt(DamageSource source, float amount) {
		...
		NatureEssenceEntityIsHurtProcedure.execute(entity);
	...
	public void die(DamageSource source) {
		...
		NatureEssenceDiesProcedure.execute(world, sourceentity);
	}
