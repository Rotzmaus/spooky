...
import net.mcreator.spooky.procedures.AnimeCowEntityIsHurtProcedure;
import net.mcreator.spooky.procedures.AnimeCowDiesProcedure;
import net.mcreator.spooky.init.SpookyModEntities;

public class AnimeCowEntity extends Monster {
	public AnimeCowEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(SpookyModEntities.ANIME_COW, world);
	}

	public AnimeCowEntity(EntityType<AnimeCowEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
		setCustomName(new TextComponent("kawaii cow"));
	...
	public boolean hurt(DamageSource source, float amount) {
		...
		AnimeCowEntityIsHurtProcedure.execute(entity);
	...
	public void die(DamageSource source) {
		...
		AnimeCowDiesProcedure.execute(world, sourceentity);
	}

	public static void init() {
		DungeonHooks.addDungeonMob(SpookyModEntities.ANIME_COW, 180);
	}
